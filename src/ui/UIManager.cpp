...
namespace UIManager {
    ...
    void LoadAyudaResources() {//Se carga imagen con su descripción
        const char* textos[] = {
                ...
                "En el filtro combinado marque la casilla de modo estricto (AND) para mostrar solo paquetes que cumplan con todos los criterios simultáneamente, o mantengalo desmarcado (OR) para mostrar paquetes que coincidan con al menos uno de los criterios seleccionados.",
                ...
                "Al dar clic derecho sobre cualquier paquete se abrira un menú de opciones. Seleccione el campo deseado para copiar automáticamente su valor.",
                "El apartado de etiquetas permite gestionarlas (se guardan automáticamente, por lo que el sniffer las recordará a menos de que se eliminen manualmente).",
